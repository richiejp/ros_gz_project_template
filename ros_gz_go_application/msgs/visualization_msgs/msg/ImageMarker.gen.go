...
type ImageMarker struct {
	...
	Ns string `yaml:"ns" json:"ns" mapstructure:"ns"`// Namespace which is used with the id to form a unique id.
	Id int32 `yaml:"id" json:"id" mapstructure:"id"`// Unique id within the namespace.
	Type int32 `yaml:"type" json:"type" mapstructure:"type"`// One of the above types, e.g. CIRCLE, LINE_STRIP, etc.
	Action int32 `yaml:"action" json:"action" mapstructure:"action"`// Either ADD or REMOVE.
	Position geometry_msgs_msg.Point `yaml:"position" json:"position" mapstructure:"position"`// Two-dimensional coordinate position, in pixel-coordinates.
	Scale float32 `yaml:"scale" json:"scale" mapstructure:"scale"`// The scale of the object, e.g. the diameter for a CIRCLE.
	OutlineColor std_msgs_msg.ColorRGBA `yaml:"outline_color" json:"outline_color" mapstructure:"outline_color"`// The outline color of the marker.
	Filled uint8 `yaml:"filled" json:"filled" mapstructure:"filled"`// Whether or not to fill in the shape with color.
	FillColor std_msgs_msg.ColorRGBA `yaml:"fill_color" json:"fill_color" mapstructure:"fill_color"`// Fill color; in the range: [0.0-1.0]
	...
	Points []geometry_msgs_msg.Point `yaml:"points" json:"points" mapstructure:"points"`// Coordinates in 2D in pixel coords. Used for LINE_STRIP, LINE_LIST, POINTS, etc.
	OutlineColors []std_msgs_msg.ColorRGBA `yaml:"outline_colors" json:"outline_colors" mapstructure:"outline_colors"`// The color for each line, point, etc. in the points field.
}
