...
type GetPlan_Request struct {
	Start geometry_msgs_msg.PoseStamped `yaml:"start" json:"start" mapstructure:"start"`// The start pose for the plan
	Goal geometry_msgs_msg.PoseStamped `yaml:"goal" json:"goal" mapstructure:"goal"`// The final pose of the goal position
	Tolerance float32 `yaml:"tolerance" json:"tolerance" mapstructure:"tolerance"`// If the goal is obstructed, how many meters the planner canrelax the constraint in x and y before failing.
}
