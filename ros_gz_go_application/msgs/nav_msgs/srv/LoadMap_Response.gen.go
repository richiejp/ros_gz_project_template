...
type LoadMap_Response struct {
	Map nav_msgs_msg.OccupancyGrid `yaml:"map" json:"map" mapstructure:"map"`// Returned map is only valid if result equals RESULT_SUCCESS
	Result uint8 `yaml:"result" json:"result" mapstructure:"result"`
}
