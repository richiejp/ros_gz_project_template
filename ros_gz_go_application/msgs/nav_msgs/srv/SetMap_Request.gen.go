...
type SetMap_Request struct {
	Map nav_msgs_msg.OccupancyGrid `yaml:"map" json:"map" mapstructure:"map"`// Requested 2D map to be set.
	InitialPose geometry_msgs_msg.PoseWithCovarianceStamped `yaml:"initial_pose" json:"initial_pose" mapstructure:"initial_pose"`// Estimated initial pose when setting new map.
}
