...
type MapMetaData struct {
	MapLoadTime builtin_interfaces_msg.Time `yaml:"map_load_time" json:"map_load_time" mapstructure:"map_load_time"`// The time at which the map was loaded
	Resolution float32 `yaml:"resolution" json:"resolution" mapstructure:"resolution"`// The map resolution [m/cell]
	Width uint32 `yaml:"width" json:"width" mapstructure:"width"`// Map width [cells]
	Height uint32 `yaml:"height" json:"height" mapstructure:"height"`// Map height [cells]
	Origin geometry_msgs_msg.Pose `yaml:"origin" json:"origin" mapstructure:"origin"`// The origin of the map [m, m, rad].  This is the real-world pose of thebottom left corner of cell (0,0) in the map.
}
