...
type Path struct {
	Header std_msgs_msg.Header `yaml:"header" json:"header" mapstructure:"header"`// Indicates the frame_id of the path.
	Poses []geometry_msgs_msg.PoseStamped `yaml:"poses" json:"poses" mapstructure:"poses"`// Array of poses to follow.
}
