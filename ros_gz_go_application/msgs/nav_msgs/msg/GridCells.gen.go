...
type GridCells struct {
	...
	CellWidth float32 `yaml:"cell_width" json:"cell_width" mapstructure:"cell_width"`// Width of each cell
	CellHeight float32 `yaml:"cell_height" json:"cell_height" mapstructure:"cell_height"`// Height of each cell
	Cells []geometry_msgs_msg.Point `yaml:"cells" json:"cells" mapstructure:"cells"`// Each cell is represented by the Point at the center of the cell
}
