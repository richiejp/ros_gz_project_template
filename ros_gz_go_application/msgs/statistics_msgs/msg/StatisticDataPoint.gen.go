...
type StatisticDataPoint struct {
	DataType uint8 `yaml:"data_type" json:"data_type" mapstructure:"data_type"`// The statistic type of this data point, defined in StatisticDataType.msgDefault value should be StatisticDataType.STATISTICS_DATA_TYPE_UNINITIALIZED (0).
	Data float64 `yaml:"data" json:"data" mapstructure:"data"`// The value of the data point
}
