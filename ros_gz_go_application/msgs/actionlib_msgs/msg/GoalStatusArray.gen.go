...
type GoalStatusArray struct {
	Header std_msgs_msg.Header `yaml:"header" json:"header" mapstructure:"header"`// Stores the statuses for goals that are currently being trackedby an action server
	StatusList []GoalStatus `yaml:"status_list" json:"status_list" mapstructure:"status_list"`
}
