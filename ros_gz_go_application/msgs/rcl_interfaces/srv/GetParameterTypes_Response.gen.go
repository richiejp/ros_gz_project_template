...
type GetParameterTypes_Response struct {
	Types []uint8 `yaml:"types" json:"types" mapstructure:"types"`// List of types which is the same length and order as the provided names.The type enum is defined in ParameterType.msg. ParameterType.PARAMETER_NOT_SETindicates that the parameter is not currently set.
}
