...
type ListParameters_Request struct {
	Prefixes []string `yaml:"prefixes" json:"prefixes" mapstructure:"prefixes"`// The list of parameter prefixes to query.
	Depth uint64 `yaml:"depth" json:"depth" mapstructure:"depth"`// Relative depth from given prefixes to return.Use DEPTH_RECURSIVE to get the recursive parameters and prefixes for each prefix.
}
