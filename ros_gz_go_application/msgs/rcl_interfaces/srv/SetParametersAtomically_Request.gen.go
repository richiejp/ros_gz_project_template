...
type SetParametersAtomically_Request struct {
	Parameters []rcl_interfaces_msg.Parameter `yaml:"parameters" json:"parameters" mapstructure:"parameters"`// A list of parameters to set atomically.This call will either set all values, or none of the values.
}
