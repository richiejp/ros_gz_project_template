...
type SetParameters_Response struct {
	Results []rcl_interfaces_msg.SetParametersResult `yaml:"results" json:"results" mapstructure:"results"`// Indicates whether setting each parameter succeeded or not and why.
}
