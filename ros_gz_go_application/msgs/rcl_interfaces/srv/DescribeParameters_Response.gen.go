...
type DescribeParameters_Response struct {
	Descriptors []rcl_interfaces_msg.ParameterDescriptor `yaml:"descriptors" json:"descriptors" mapstructure:"descriptors"`// A list of the descriptors of all parameters requested in the same orderas they were requested. This list has the same length as the list ofparameters requested.
}
