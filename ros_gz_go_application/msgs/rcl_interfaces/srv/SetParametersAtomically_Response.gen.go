...
type SetParametersAtomically_Response struct {
	Result rcl_interfaces_msg.SetParametersResult `yaml:"result" json:"result" mapstructure:"result"`// Indicates whether setting all of the parameters succeeded or not and why.
}
