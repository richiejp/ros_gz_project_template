...
type Log struct {
	Stamp builtin_interfaces_msg.Time `yaml:"stamp" json:"stamp" mapstructure:"stamp"`// Timestamp when this message was generated by the node.
	Level uint8 `yaml:"level" json:"level" mapstructure:"level"`// Corresponding log level, see above definitions.
	Name string `yaml:"name" json:"name" mapstructure:"name"`// The name representing the logger this message came from.
	Msg string `yaml:"msg" json:"msg" mapstructure:"msg"`// The full log message.
	File string `yaml:"file" json:"file" mapstructure:"file"`// The file the message came from.
	Function string `yaml:"function" json:"function" mapstructure:"function"`// The function the message came from.
	Line uint32 `yaml:"line" json:"line" mapstructure:"line"`// The line in the file the message came from.
}
