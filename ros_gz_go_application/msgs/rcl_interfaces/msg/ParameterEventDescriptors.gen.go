...
type ParameterEventDescriptors struct {
	NewParameters []ParameterDescriptor `yaml:"new_parameters" json:"new_parameters" mapstructure:"new_parameters"`
	ChangedParameters []ParameterDescriptor `yaml:"changed_parameters" json:"changed_parameters" mapstructure:"changed_parameters"`
	DeletedParameters []ParameterDescriptor `yaml:"deleted_parameters" json:"deleted_parameters" mapstructure:"deleted_parameters"`
}
