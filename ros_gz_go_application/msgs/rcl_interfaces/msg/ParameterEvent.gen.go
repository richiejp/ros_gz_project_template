...
type ParameterEvent struct {
	Stamp builtin_interfaces_msg.Time `yaml:"stamp" json:"stamp" mapstructure:"stamp"`// The time stamp when this parameter event occurred.
	Node string `yaml:"node" json:"node" mapstructure:"node"`// Fully qualified ROS path to node.
	NewParameters []Parameter `yaml:"new_parameters" json:"new_parameters" mapstructure:"new_parameters"`// New parameters that have been set for this node.
	ChangedParameters []Parameter `yaml:"changed_parameters" json:"changed_parameters" mapstructure:"changed_parameters"`// Parameters that have been changed during this event.
	DeletedParameters []Parameter `yaml:"deleted_parameters" json:"deleted_parameters" mapstructure:"deleted_parameters"`// Parameters that have been deleted during this event.
}
