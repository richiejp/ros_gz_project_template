...
type Parameter struct {
	Name string `yaml:"name" json:"name" mapstructure:"name"`// The full name of the parameter.
	Value ParameterValue `yaml:"value" json:"value" mapstructure:"value"`// The parameter's value which can be one of several types, see`ParameterValue.msg` and `ParameterType.msg`.
}
