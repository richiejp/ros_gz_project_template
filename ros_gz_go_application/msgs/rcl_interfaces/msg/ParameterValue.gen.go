...
type ParameterValue struct {
	Type uint8 `yaml:"type" json:"type" mapstructure:"type"`// The type of this parameter, which corresponds to the appropriate field below.
	BoolValue bool `yaml:"bool_value" json:"bool_value" mapstructure:"bool_value"`// Boolean value, can be either true or false.
	IntegerValue int64 `yaml:"integer_value" json:"integer_value" mapstructure:"integer_value"`// Integer value ranging from -9,223,372,036,854,775,808 to9,223,372,036,854,775,807.
	DoubleValue float64 `yaml:"double_value" json:"double_value" mapstructure:"double_value"`// A double precision floating point value following IEEE 754.
	StringValue string `yaml:"string_value" json:"string_value" mapstructure:"string_value"`// A textual value with no practical length limit.
	ByteArrayValue []byte `yaml:"byte_array_value" json:"byte_array_value" mapstructure:"byte_array_value"`// An array of bytes, used for non-textual information.
	BoolArrayValue []bool `yaml:"bool_array_value" json:"bool_array_value" mapstructure:"bool_array_value"`// An array of boolean values.
	IntegerArrayValue []int64 `yaml:"integer_array_value" json:"integer_array_value" mapstructure:"integer_array_value"`// An array of 64-bit integer values.
	DoubleArrayValue []float64 `yaml:"double_array_value" json:"double_array_value" mapstructure:"double_array_value"`// An array of 64-bit floating point values.
	StringArrayValue []string `yaml:"string_array_value" json:"string_array_value" mapstructure:"string_array_value"`// An array of string values.
}
