...
type SetParametersResult struct {
	Successful bool `yaml:"successful" json:"successful" mapstructure:"successful"`// A true value of the same index indicates that the parameter was setsuccessfully. A false value indicates the change was rejected.
	Reason string `yaml:"reason" json:"reason" mapstructure:"reason"`// Reason why the setting was a failure. On success, the contents of this fieldare undefined.  This should only be used for logging and user interfaces.
}
