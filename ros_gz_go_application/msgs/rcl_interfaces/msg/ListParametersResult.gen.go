...
type ListParametersResult struct {
	Names []string `yaml:"names" json:"names" mapstructure:"names"`// The resulting parameters under the given prefixes.
	Prefixes []string `yaml:"prefixes" json:"prefixes" mapstructure:"prefixes"`// The resulting prefixes under the given prefixes.TODO(wjwwood): link to prefix definition and rules.
}
