...
type TransitionDescription struct {
	Transition Transition `yaml:"transition" json:"transition" mapstructure:"transition"`// The transition id and label of this description.
	StartState State `yaml:"start_state" json:"start_state" mapstructure:"start_state"`// The current state from which this transition transitions.
	GoalState State `yaml:"goal_state" json:"goal_state" mapstructure:"goal_state"`// The desired target state of this transition.
}
