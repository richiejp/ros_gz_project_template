...
type Transition struct {
	Id uint8 `yaml:"id" json:"id" mapstructure:"id"`// The transition id from above definitions.
	Label string `yaml:"label" json:"label" mapstructure:"label"`// A text label of the transition.
}
