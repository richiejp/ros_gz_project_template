...
type GetAvailableTransitions_Response struct {
	AvailableTransitions []lifecycle_msgs_msg.TransitionDescription `yaml:"available_transitions" json:"available_transitions" mapstructure:"available_transitions"`// An array of the possible start_state-goal_state transitions
}
