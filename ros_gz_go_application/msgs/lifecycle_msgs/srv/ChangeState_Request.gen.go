...
type ChangeState_Request struct {
	Transition lifecycle_msgs_msg.Transition `yaml:"transition" json:"transition" mapstructure:"transition"`// The requested transition.This change state service will fail if the transition is not possible.
}
