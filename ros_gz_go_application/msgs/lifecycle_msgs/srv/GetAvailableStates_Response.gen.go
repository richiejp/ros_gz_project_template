...
type GetAvailableStates_Response struct {
	AvailableStates []lifecycle_msgs_msg.State `yaml:"available_states" json:"available_states" mapstructure:"available_states"`// Array of possible states that can be transitioned to.
}
